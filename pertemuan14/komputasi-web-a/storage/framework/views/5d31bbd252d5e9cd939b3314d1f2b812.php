...
<body class="m-4" style="font-family: Heebo">
    ...
    <div class="py-3 my-3">
        <a class="btn btn-primary" href="<?php echo e(route('biodatas.create')); ?>">Tambah Biodata</a>
    </div>
        ...
        <tbody>
            <?php $__currentLoopData = $biodatas; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $biodata): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <tr>
                    ...
                    <td>
                        <a class="btn btn-dark py-1 px-4" href="<?php echo e(route('biodatas.edit', $biodata->id)); ?>">Edit</a>
...
<?php /**PATH D:\UPJ\Komputasi Berbasis Web\pertemuan14\komputasi-web-a\resources\views/biodatas/index.blade.php ENDPATH**/ ?>