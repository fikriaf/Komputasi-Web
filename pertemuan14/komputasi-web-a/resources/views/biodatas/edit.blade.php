...
<body class="m-4 w-100" style="font-family: Heebo">
    ...
    <div class="p-3 my-3 border w-25 shadow-sm rounded">
        <form action="{{ route('biodatas.update', $biodata->id) }}" method="POST">
            ...
            <input class="form-control" type="text" name="first_name" id="first_name" value="{{ $biodata->first_name }}" required>
            <label for="last_name">Nama Belakang:</label>
            <input class="form-control" type="text" name="last_name" id="last_name" value="{{ $biodata->last_name }}" required>
            <br>
    ...
    <div>
        <a class="btn btn-outline-secondary" href="{{ route('biodatas.index') }}">Kembali ke Daftar Biodata</a>
    </div>    
    <!-- BOOTSTRAP -->
